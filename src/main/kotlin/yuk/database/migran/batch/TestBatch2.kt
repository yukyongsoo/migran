...
class TestBatch2(
    ...
    fun initialize() {
        ...
        batchStepBuilder.setBasicData("testStep2", 10)
    ...
    private fun getTestReader(readerBuilder: StepReaderBuilder<String>): ItemReader<String> {
        return readerBuilder.getItemReader("testReadStep2") {
